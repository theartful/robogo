...
$("#human-human-start").on("click", function(event) {
  ...
  if (player1 && player2) {
    window.location =
      `./game.html?player1=human&player2=human&player1_name=${player1}&player2_name=${player2}`;
  } else {
    $.growl({
      title: "Error",
...
$("#human-cmp-start").on("click", function(event) {
  ...
  if (player1) {
    window.location =
      `./game.html?player1=human&player2=cmp&player1_name=${player1}&player2_name=CMP`;
  } else {
    $.growl({
      title: "Error",
