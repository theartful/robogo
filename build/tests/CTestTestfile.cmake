...
add_test("goslayer-unit-tests:Check passes action" "/media/reem/Data/4th years projects/MI - Project/RoboGo/build/bin/goslayer-unit-tests" "Check passes action")
set_tests_properties("goslayer-unit-tests:Check passes action" PROPERTIES  FAIL_REGULAR_EXPRESSION "No tests ran" LABELS "goslayer-unit-tests")
...
add_test("goslayer-unit-tests:Testing Capture manually" "/media/reem/Data/4th years projects/MI - Project/RoboGo/build/bin/goslayer-unit-tests" "Testing Capture manually")
set_tests_properties("goslayer-unit-tests:Testing Capture manually" PROPERTIES  FAIL_REGULAR_EXPRESSION "No tests ran" LABELS "goslayer-unit-tests")
add_test("goslayer-unit-tests: Testing SGF is working Correctly" "/media/reem/Data/4th years projects/MI - Project/RoboGo/build/bin/goslayer-unit-tests" " Testing SGF is working Correctly")
set_tests_properties("goslayer-unit-tests: Testing SGF is working Correctly" PROPERTIES  FAIL_REGULAR_EXPRESSION "No tests ran" LABELS "goslayer-unit-tests")
